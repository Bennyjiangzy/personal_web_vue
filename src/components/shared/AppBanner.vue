...
<template>
	...
	>
	<div class="w-full md:w-1/4 text-right float-right"></div>
		...
		<div class="w-full md:w-1/3 text-left">
			...
			>
				A Software Developer & IT Enthusiast
			</p>
			<div class="flex justify-center sm:block">
				<a
					download="Benny-Resume.pdf"
					href="/files/bennyj_res.pdf"
		...
		<div class="w-full md:w-1/4 text-right float-right ">
			<img
				v-if="theme === 'light'"
